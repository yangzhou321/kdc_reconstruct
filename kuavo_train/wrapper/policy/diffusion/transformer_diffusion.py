"""
This file is adapted from the implementation of the Transformer for diffusion model
in the Diffusion Policy project.

Original source:
  https://github.com/real-stanford/diffusion_policy/blob/main/diffusion_policy/model/diffusion/transformer_for_diffusion.py

No functional changes have been made other than refactoring for local usage.
"""
